...
namespace buttonVar {
    button buttonCreate = {{50.0f, 430.0f, button::sizeW, button::sizeH}, color::buttonColor, "Create"};
    button buttonIns    = {{50.0f, 480.0f, button::sizeW, button::sizeH}, color::buttonColor, "Insert"};
    button buttonDel    = {{50.0f, 530.0f, button::sizeW, button::sizeH}, color::buttonColor, "Delete"};
    button buttonF      = {{50.0f, 580.0f, button::sizeW, button::sizeH}, color::buttonColor, "Find"};
    button buttonClear  = {{50.0f, 630.0f, button::sizeW, button::sizeH}, color::buttonColor, "Clear"};
    button buttonGo     = {{300.0f, 580.0f, 60,40}, color::buttonFile, "Go"};
}
